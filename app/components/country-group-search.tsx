...
export default function CountryGroupSearch() {
  ...
  const propertyOptions: Array<{ key: string; label: string }> = [
  ...
  const performSearch = () => {
    ...
    switch (searchType) {
      ...
      case "extremeValues":
        ...
        break
      case "memberships":
        results = getCountriesWithMemberships(memberships)
        break
    }
  ...
  // Füge eine Eigenschaft hinzu
  const addProperty = (property: string) => {
    setProperties((prev) => [...prev, property])
  }

  // Entferne eine Eigenschaft
  ...
  const countries = searchResults.map((code) => countriesData.find((c) => c.code === code)).filter(Boolean)

  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Ländergruppen-Suche</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        <div className="mb-4">
          ...
          >
            ...
            <option value="memberships">Länder mit bestimmten Mitgliedschaften</option>
          </select>
        </div>

        {/* Suchoptionen basierend auf dem ausgewählten Suchtyp */}
        {searchType === "matchingCriteria" && (
          <div className="mb-4">
        ...
        {(searchType === "multipleGroups" || searchType === "anyGroup") && (
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <select
                className="w-full p-2 border border-gray-300 rounded-md"
                onChange={(e) => {
                  if (e.target.value && !properties.includes(e.target.value)) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setUnusualProperty(e.target.value)}
                  className="w-full p-2 border border-gray-300 rounded-md"
                >
                  <option value="" disabled>
                    Eigenschaft auswählen
      ...
      {searchResults.length > 0 && (
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-bold mb-4">Suchergebnisse ({searchResults.length} Länder)</h2>
